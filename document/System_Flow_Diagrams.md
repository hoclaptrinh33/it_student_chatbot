...
9. **LLM Generation**: Xây prompt với context + history, gọi dịch vụ AI
...
sequenceDiagram
 ...
 alt Cache HIT Cache-->>Chat: cached_answer
 ...
 Note right of LLM: AI model được cấu hình<br/>theo môi trường triển khai
